...
result.save_npz(out / 'result.npz')
result.save_summary_json(out / 'summary.json')
result.plot_all(out / 'figures')
print('Done. Summary saved to', out)
print('h_min:', float(np.nanmin(result.h)), 'h_max:', float(np.nanmax(result.h)))
